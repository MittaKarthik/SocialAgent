...
class InstagramAgent: SocialAgentDelegate
{
    ...
    private init() {
        let userConstants : SocialAgentPersistanceConstants  = SocialAgentPersistanceConstants()
        self.userModel.userConstants = userConstants
...
//    let user : SocialAgentUserModel = { () -> SocialAgentUserModel in
//      
//        
//        
//        return x
//    }
    ...
    func login(_: CompletionBlock)
    {
        ...
        let instagramSignInVC = storyboard.instantiateViewControllerWithIdentifier(ThisConstants.instagramSignInVCStoryboardID)
