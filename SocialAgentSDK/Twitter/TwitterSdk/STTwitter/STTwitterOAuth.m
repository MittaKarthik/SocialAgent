...
@property (nonatomic, assign) BOOL isLoginCall;
...
- (void)postAuthAccessTokenRequestWith:(NSString*)oauth_Verifier SuccessBlock:(void(^)(NSString *oauthToken, NSString *oauthTokenSecret, NSString *userID, NSString *screenName))successBlock
                                     errorBlock:(void(^)(NSError *error))errorBlock {
...
//
//    NSString *signature = [[self class] oauthSignatureWithHTTPMethod:@"POST"
...
//    =uw7NjWHT6OJ1MpJOXsHfNxoAhPKpgI8BlYDhxEjIBY
    NSDictionary *d = @{@"oauth_verifier" : oauth_Verifier};
